...
<solution name="stdioImporter.runtime" uuid="d1a1b00e-e5c0-4fee-bd03-df702239c847" compileInMPS="true">
  <models>
    ...
    <modelRoot contentPath="${headerimporter.home}/headerimporter/bparser/out/artifacts/bparser_jar" type="java_classes">
      <sourceRoot location="bparser.jar" />
    </modelRoot>
  </models>
  <stubModelEntries>
    <stubModelEntry path="${headerimporter.home}/headerimporter/bparser/out/artifacts/bparser_jar/bparser.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
